...
import com.example.digitekademoappapplirossel.adapters.SecondArticleAdapter
...
class ViewPagerFragment: Fragment() {
    ...
    private lateinit var secondArticlesRecyclerView: RecyclerView
    ...
    override fun onCreateView(
        ...
        secondArticlesRecyclerView = view.findViewById(R.id.fragment_second_articles)
        return view
    }
            ...
            webView.apply {
                ...
                webViewClient = object : WebViewClient() {
                    override fun onPageFinished(view: WebView?, url: String?) {
                        ...
                        instantiateSecondArticlesRecyclerView()
                    }
                }
            }
        }
    ...
    private fun instantiateSecondArticlesRecyclerView() {
        if (this::secondArticlesRecyclerView.isInitialized) {
            secondArticlesRecyclerView.apply {
                layoutManager = LinearLayoutManager(requireContext())
                adapter = SecondArticleAdapter(context = requireContext())
            }
        }
    }
}